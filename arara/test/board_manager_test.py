...
class BoardManagerTest(unittest.TestCase):
    ...
    def testBoardWithCategory(self):
        ...
        expect_dict = {None: [Board(read_only=False, hide=True, board_description=u'Testing Board', order=2, board_name=u'test2', headings=None, category_id=None, id=2)], u'test_category': [Board(read_only=False, hide=False, board_description=u'Testing Board', order=1, board_name=u'test', headings=None, category_id=1, id=1)]}
        expect_list = [[Board(read_only=False, hide=False, board_description=u'Testing Board', order=1, board_name=u'test', headings=None, category_id=1, id=1)], [Board(read_only=False, hide=True, board_description=u'Testing Board', order=2, board_name=u'test2', headings=None, category_id=None, id=2)]]
